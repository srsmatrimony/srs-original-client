...
const FormAdvanceProfileAdd = () => {
  ...
  const { loading, success,error, userProfile } = useSelector(state => state.userProfile);
  ...
  const handleSubmit=(e)=>{
    ...
    const errorObj = { ...errorsObj };
        ...
        if(error){
          ...
          const profileData={aboutMe,countryLiving,currentLocation,nativePlace,diet,smoking,drinking,occupation , annualIncome , residential,contact,family,education,advanceProfileStatus:true,profileCompletion:"100" };
              ...
              <Col xl={6} className="col-xxl-12">
                  <Card>
                    ...
                    <Card.Body>
                        ...
                        >
                          <strong> You have already entered the Advance Info !!!</strong> Please edit the Advance Info.
                        </Alert>
                ...
                <Col xl={6} className="col-xxl-12">
                  <Card>
                    <Card.Body>
                      <Link to="/form-edit-advance-info"> Click Here to Fill Up your  Profile </Link>
                    </Card.Body>
