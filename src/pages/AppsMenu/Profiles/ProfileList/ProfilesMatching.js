...
//   const userDetails = useSelector(state => state.auth.user);
  ...
  const { matchingProfiles,loading,error} = useSelector(state => state.profiles);
    ...
    return (
      <Fragment>
        <PageTitle activeMenu="Matching Profiles" motherMenu="Profiles" />
        {
          ...
          <div className="row">
            {matchingProfiles ? matchingProfiles.map((profile) => <SingleProfileList key={profile._id} profile={profile} />) :
              <div className="text-danger text-center ">
                No profiles found. please wait a while for matching profiles
              </div>
            }
