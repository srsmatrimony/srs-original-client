...
import { getReceivedInterestProfiles } from '../../../../store/profiles/profileActions';
...
const ProfilesInterestReceived = () => {
  ...
  const { receivedInterestProfiles,loading ,error} = useSelector(state => state.profiles);
    ...
    return (
      <Fragment>
        <PageTitle activeMenu="Matching Profiles" motherMenu="Profiles" />
        {
          ...
          <div className="row">
            {receivedInterestProfiles ? receivedInterestProfiles.map((profile) => <SingleProfileList key={profile._id} profile={profile} />) :
          
              <div className="text-danger text-center ">
                No profiles found. please wait a while for an interest sent by a user.
              </div>
            }
...
export default  ProfilesInterestReceived ;
